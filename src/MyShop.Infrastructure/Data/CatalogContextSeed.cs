    ...
    public class CatalogContextSeed
    {
        public static async Task SeedAsync(CatalogContext catalogContext, ILogger logger, int retry = 0)
        {
            ...
            try
            {
                ...
                {
                    await catalogContext.AddRangeAsync(GetPreGonfigureBrands());
            ...
            catch (Exception ex)
            {
                ...
                await SeedAsync(catalogContext, logger, retry);
            }
        }
        ...
        private static IEnumerable<CatalogBrand> GetPreGonfigureBrands()
        {
